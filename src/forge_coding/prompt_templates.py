...
def load_prompt_templates(paths: ForgeResourcePaths | None = None) -> list[PromptTemplate]:
    """Load markdown prompt templates from Forge and `.agents` resource directories."""
