"""Small Textual widgets for Forge's interactive TUI."""
...
class ForgeMarkdownBlock(MarkdownBlock):
    """Markdown block that applies Forge's themed inline link color."""
    ...
    def _token_to_content(self, token: Any) -> Any:
        ...
        if not isinstance(markdown, ThemedMarkdownWidget):
            return content
        link_style = TextualStyle.parse(markdown.forge_link_style)
        spans = []
...
class ThemedMarkdownWidget(TextualMarkdown):
    """Textual Markdown widget reserved for Forge transcript streaming."""

    BLOCKS = {**TextualMarkdown.BLOCKS, "paragraph_open": ForgeMarkdownBlock}
    ...
    def __init__(
        ...
        *,
        ...
        self.forge_link_style = theme.markdown_link
...
class TranscriptView(VerticalScroll):
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        ...
        self._render_theme: TuiTheme = FORGE_DARK_THEME
...
class ThemedCodeBlock(CodeBlock):
    """Rich Markdown code block with Forge's themed background color."""
...
class ThemedMarkdown(Markdown):
    """Markdown renderer with Forge's softer heading/accent colors."""
