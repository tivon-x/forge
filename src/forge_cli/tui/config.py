...
FORGE_DARK_THEME = TuiTheme(
    ...
    role_styles={
        ...
        "subagent": TuiRoleStyle(border="#6ea8fe", body="#cbd5e1 on #000000"),
        "subagent-running": TuiRoleStyle(border="#6ea8fe", body="#d8dee9 on #000000"),
        "subagent-success": TuiRoleStyle(border="#9cffb1", body="#d8dee9 on #000000"),
        "subagent-error": TuiRoleStyle(border="#ff4f4f", body="#ffb4b4 on #000000"),
...
HIGH_CONTRAST_THEME = TuiTheme(
    ...
    role_styles={
        ...
        "subagent": TuiRoleStyle(border="#8fc1ff", body="white on #000000"),
        "subagent-running": TuiRoleStyle(border="#8fc1ff", body="white on #001626"),
        "subagent-success": TuiRoleStyle(border="#00ff66", body="white on #001a0b"),
        "subagent-error": TuiRoleStyle(border="#ff4f4f", body="white on #260000"),
...
FORGE_LIGHT_THEME = TuiTheme(
    ...
    role_styles={
        ...
        "subagent": TuiRoleStyle(border="#2563eb", body="#1f2937"),
        "subagent-running": TuiRoleStyle(border="#2563eb", body="#1f2937"),
        "subagent-success": TuiRoleStyle(border="#166534", body="#14532d"),
        "subagent-error": TuiRoleStyle(border="#b91c1c", body="#7f1d1d"),
